<div class="container py-4">
    ...
    <div class="position-relative mb-4">
        <input type="text" wire:model.live.debounce.300ms="busqueda"
               class="form-control" placeholder="Busca por nombre de producto o color...">
            ...
            <tbody>
                @foreach ($items as $index => $item)
                    <tr wire:key="sale-item-{{ $item['variant_id'] }}">
                        ...
                        <td>
                            <input type="number" step="0.01" wire:model.live="items.{{ $index }}.precio_venta"
                                   class="form-control form-control-sm">
                        </td>
                        <td>
                        ...
                        <td>
                            <button wire:click="quitarItem({{ $index }})" class="btn btn-sm btn-outline-danger">×</button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
